...
- [`builder-protocol-v1.schema.json`](../contracts/builder-protocol-v1.schema.json): semántica del servicio entre cliente y Builder;
- [`builder-driver-v1.schema.json`](../contracts/builder-driver-v1.schema.json): semántica del proceso entre Builder y el driver del lenguaje;
- [`builder-driver-registration-v1.schema.json`](../contracts/builder-driver-registration-v1.schema.json): metadata de descubrimiento portable para drivers de proceso.
