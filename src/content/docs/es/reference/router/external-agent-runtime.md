---
title: "Runtime de agentes externos v1"
...
La toolchain puede extenderse a otros lenguajes mediante [`Builder Protocol v1`](../builder-protocol/). Los SDK siguen siendo únicamente de autoría; las herramientas de desarrollo llaman a Builder, y Builder delega pruebas y empaquetado a un driver de lenguaje exacto e identificado por contenido.
