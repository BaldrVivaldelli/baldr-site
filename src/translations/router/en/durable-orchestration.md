...
The frozen policy implements [`orchestration-policy-v1.schema.json`](../contracts/orchestration-policy-v1.schema.json) and declares limits, per-role cardinality, and the `exactly-one-per-write-phase` rule.
